    ...
    sm?h('div',{className:'grid grid2 section-gap'},
      h('div',{className:'card',style:{margin:'0'}},
        ...
        h('div',{className:'grid grid2'},
          h('div',null,h('div',{className:'stat-l'},t('download')),h('div',{style:{fontSize:'16px',fontWeight:'700',fontFamily:'var(--m)',color:'var(--gn)'}},fmt(sm.today?sm.today.down:0))),
          h('div',null,h('div',{className:'stat-l'},t('upload')),h('div',{style:{fontSize:'16px',fontWeight:'700',fontFamily:'var(--m)',color:'var(--or)'}},fmt(sm.today?sm.today.up:0))),
      ...
      h('div',{className:'card',style:{margin:'0'}},
        ...
        h('div',{className:'grid grid2'},
          h('div',null,h('div',{className:'stat-l'},t('download')),h('div',{style:{fontSize:'16px',fontWeight:'700',fontFamily:'var(--m)',color:'var(--gn)'}},fmt(sm.week?sm.week.down:0))),
          h('div',null,h('div',{className:'stat-l'},t('upload')),h('div',{style:{fontSize:'16px',fontWeight:'700',fontFamily:'var(--m)',color:'var(--or)'}},fmt(sm.week?sm.week.up:0))),
